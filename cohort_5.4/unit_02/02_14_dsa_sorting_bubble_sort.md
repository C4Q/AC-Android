...
* When we study performance we want to understand the scalibility of    algorithim 
* Peformance will draw the line between what is feasible and what is impossible 
...
*  A bubble sort algorithim walks through (iterates) through some collection and compares two elements at a time
